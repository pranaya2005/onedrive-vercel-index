...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'pranaya@334s3m.onmicrosoft.com',
  ...
  googleFontSans: 'Reddit Sans',
  // googleFontMono - the monospace font used in onedrive-vercel-index.
  googleFontMono: 'Reddit Mono',
  // googleFontLinks -  an array of links for referencing the google font assets.
  googleFontLinks: ['https://fonts.googleapis.com/css2?family=Reddit+Mono&family=Reddit+Sans:wght@400;500;700&display=swap'],
